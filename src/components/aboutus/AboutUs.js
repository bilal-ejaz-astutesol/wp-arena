    ...
    <>
      ...
      <section>
                <div class="wpa-quiz-banner wpa-no-bg wpa-wrapper-sides-spacing">
                    <div class="wpa-flex wpa-gap-xxl wpa-about-us-page">

                        <div class="wpa-quiz-content wpa-h2-font-size wpa-paragraph-text btn-dark btn-primary-hover  wpa-font-weight-600 wpa-margin-negative">
                            <h2>About WPArena</h2>
