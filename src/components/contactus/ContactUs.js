                    ...
                    <form action=''>
                        ...
                        <div className='wpa-form-inner'>
                            ...
                            <div className='wpa-form-group wpa-flex wpa-content-top-bottom-spacing-30 wpa-menu-items-gap'>
                                <select className='className=' wpa-input-padding-20>
                                ...
                                <textarea className='wpa-input-padding-20' placeholder='Messgae'></textarea>
                            </div>
                            <div className='wpa-flex  wpa-ad-type wpa-padding-bottom-20px'>
                                <div className='wpa-radio-wrapper wpa-flex wpa-gap-20'>
                                    ...
                                    <label for="updates">Yes, I would like to receive weekly WordPress tutorials and other updates from WPBeginner.</label>
                                </div>
                            </div>
                        </div>
